    ...
    return (
        <div id="header" className="min-h-screen flex flex-col justify-center px-6 py-20 relative overflow-hidden">
            <div className="absolute inset-0 z-0 opacity-30">
                <div
                    className="absolute top-10 left-10 w-72 h-72 bg-[#57b8ff]/20 rounded-full filter blur-3xl animate-blob"></div>
                <div
                    className="absolute bottom-10 right-10 w-72 h-72 bg-[#3C50E0]/20 rounded-full filter blur-3xl animate-blob animation-delay-2000"></div>
                <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-[#04C8C8]/10 rounded-full filter blur-3xl animate-blob animation-delay-4000"></div>
            </div>

            <div className='flex justify-around items-center'>
                <div className="max-w-4xl elative z-10">
                    <div className="animate-fadeIn">
                        <span
                            className="text-sm font-medium text-gray-400 mb-2 block tracking-wider">Привет, меня зовут</span>
                        ...
                        <p className="text-gray-400 max-w-lg mb-8 leading-relaxed">
                            Разработчик с более чем 3-летним опытом в создании современных веб-приложений с
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <a href="#tech" className="group relative px-4 py-2 rounded-md overflow-hidden">
                                <span
                                    className="absolute inset-0 w-full h-full bg-[#57b8ff]/10 group-hover:bg-[#57b8ff]/20 transition-all duration-300"></span>
                                <span
                                    className="absolute inset-0 w-0 bg-[#57b8ff]/20 group-hover:w-full transition-all duration-700"></span>
                            ...
                            <a href="#projects" className="group relative px-4 py-2 rounded-md overflow-hidden">
                                <span
                                    className="absolute inset-0 w-full h-full bg-[#3C50E0]/10 group-hover:bg-[#3C50E0]/20 transition-all duration-300"></span>
                                <span
                                    className="absolute inset-0 w-0 bg-[#3C50E0]/20 group-hover:w-full transition-all duration-700"></span>
                            ...
                            <a href="#contacts" className="group relative px-4 py-2 rounded-md overflow-hidden">
                                <span
                                    className="absolute inset-0 w-full h-full bg-[#04C8C8]/10 group-hover:bg-[#04C8C8]/20 transition-all duration-300"></span>
                                <span
                                    className="absolute inset-0 w-0 bg-[#04C8C8]/20 group-hover:w-full transition-all duration-700"></span>
                        ...
                        <div className="mt-12 flex gap-6">
                            ...
                            >
                                <div
                                    className="absolute -inset-2 bg-[#57b8ff]/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            ...
                            >
                                <div
                                    className="absolute -inset-2 bg-[#3C50E0]/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            ...
                            >
                                <div
                                    className="absolute -inset-2 bg-[#04C8C8]/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
