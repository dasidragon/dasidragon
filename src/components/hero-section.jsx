                ...
                <div className='max-w-4xl elative z-10'>
                    <div className='animate-fadeIn'>
                        ...
                        <p className='text-gray-400 max-w-lg mb-8 leading-relaxed'>
                            Разработчик с более чем 4-летним опытом в создании современных веб-приложений с использованием передовых
                            технологий. Сфокусирован на разработке решений, которые приносят реальную ценность и прибыль бизнесу.
                        </p>
