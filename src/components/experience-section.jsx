const experiences = [
    ...
    },
    {
        ...
        description:
            'Основные обязанности:\n• Поддержка существующих админ веб-приложений для автоматизации процессов в сфере ресторанови кафе, включая обеспечение стабильности и производительности.\n• Оптимизация пользовательских интерфейсов для улучшения взаимодействия с клиентами иперсоналом.\n• Работа с React-Leaflet для поддержка карт и геолокационных сервисов в веб-приложения.Настройка конфигурации Vite для сборки и оптимизации приложений, что повысило производительность и ускорило процесс разработки.\n• Внедрение новых технологий, таких как React-query, React-Hook-Form и Chartjs, для улучшения функциональности и интерфейса проекта.\n• Поддержка лендинг сайта, обеспечение его стабильной работы и оптимизации для улучшения производительности и конверсии',
    },
    {
        company: 'Cloud Soft',
        position: 'Front-end Developer',
        period: 'Октябрь 2023 - Июль 2024',
        type: 'Продуктовая компания',
        location: 'Кыргызстан, Бишкек (Full-time)',
        projects: 'CRM, Главный сайт, UBR, Лендинг сайт BSMART',
        description:
            'Основные обязанности:\n• Разработка веб-приложений и CRM-систем с использованием React и других технологий.\n• Создание кассовых решений и десктопных приложений на Electronjs для автоматизации процессов.Успешная реализация проектов в рамках установленных сроков и стандартов качества.\n• Оптимизация производительности приложений и участие в интеграции ключевых функциональных элементов.\n• Разработка на Next.js: создание лендингов и веб-приложений для улучшения SEO и повышения скорости загрузки страниц.\n• Интеграция государственных систем: внедрение и интеграция ключевых сервисов, соответствующих требованиям законодательства.',
    },
    {
        company: 'AVN',
        position: 'Front-end Developer',
        period: 'Март 2022 - Октябрь 2023',
        type: 'Аутсорсинговая компания',
        location: 'Кыргызстан, Бишкек (Full-time)',
        projects: 'Портал для приема в вузы, Главный сайт AVN, Онлайн поступления в лицей',
        description:
            'Основные обязанности:\n• Разработка и поддержка веб-приложений для образовательных целей и государственных нужд.\n• Разработал клиентский часть портала для приема в вузы Кыргызской Республики гражданзарубежных стран, который автоматизировал процесс подачи заявок, упрощая поступление иностранных абитуриентов в вузы Кыргызстана и способствуя их интеграции в образовательную систему страны. Этот проект стал важным вкладом в развитие вузов Кыргызстана, так как предоставил иностранным гражданам доступ к возможностям обучения в Кыргызстане.\n• Оптимизация интерфейсов и функциональности приложений для повышения их эффективности иудобства использования.\n• Успешно запустил проекты с нуля до полного релиза, обеспечив высокое качество исполнения и соблюдение сроков',
    },
]
